...
;// CONCATENATED MODULE: ./src/libs/plugin/gtag.ts

const GA_TRACKING_ID = (site_config_default()).googleAnalytics.config.measurementId;
...
const useGtagEffect = ()=>{
    ...
    (0,external_react_.useEffect)(()=>{
        if (!((site_config_default()).isProd && (site_config_default())?.googleAnalytics?.enable)) return;
...
const Scripts = ()=>/*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
        children: (site_config_default())?.googleAnalytics?.enable === true && /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
            children: [
                /*#__PURE__*/ jsx_runtime_.jsx((script_default()), {
                    src: `https://www.googletagmanager.com/gtag/js?id=${(site_config_default()).googleAnalytics.config.measurementId}`
                }),
                /*#__PURE__*/ jsx_runtime_.jsx((script_default()), {
                    strategy: "lazyOnload",
                    id: "ga",
            ...
            gtag('js', new Date());
            gtag('config', '${(site_config_default()).googleAnalytics.config.measurementId}', {
...
var __webpack_exports__ = __webpack_require__.X(0, [313], () => (__webpack_exec__(6812)));
